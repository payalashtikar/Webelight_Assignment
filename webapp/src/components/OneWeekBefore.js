...
export const OneWeekBefore = () => {
    ...
    const [timePeriod, setTimePeriod] = useState("OneWeekBefore")
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            let getStartDate;
            if (timePeriod === "OneWeekBefore") {
                getStartDate = new Date();
                getStartDate.setDate(getStartDate.getDate() - 7);
            }
