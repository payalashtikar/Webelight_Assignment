...
export const TwoWeekBefore = () =>{
    
    const [timePeriod, setTimePeriod] = useState("TwoWeekBefore")
    ...
    useEffect(() => {
        const getData = async () => {
           const todaysDate = new Date();
            ...
            let getStartDate;
            if (timePeriod === "TwoWeekBefore") {
                getStartDate = new Date();
                getStartDate.setDate(getStartDate.getDate() - 14);
            }
